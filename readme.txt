...
Download files, navigate to directory, vagrant up,  vagrant ssh and mysql -u root -p root and install database-dump.sql. Go to proctorsdevtest.local or 192.168.33.10 and you should be able to naviagte the site.  Login username and password is superuser.
